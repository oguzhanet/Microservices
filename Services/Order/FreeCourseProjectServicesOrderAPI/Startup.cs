...
namespace FreeCourseProjectServicesOrderAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddMassTransit(x =>
            {
                ...
                x.UsingRabbitMq((context, cfg) =>
                {
                    ...
                    cfg.ReceiveEndpoint("course-name-changed-event-order-service", o =>
                    {
                        o.ConfigureConsumer<CourseNameChangedEventConsumer>(context);
                    });
            ...
            {
                ops.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"), configure =>
                {
                    configure.MigrationsAssembly("FreeCourseProjectServicesOrderInfrastructure");
                });
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "FreeCourseProjectServicesOrderAPI", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FreeCourseProjectServicesOrderAPI v1"));
            }
